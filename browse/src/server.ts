/**
 * chief browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.chief/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.chief/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['chief browse — headless browser for AI agents', '', 'Commands:'];
