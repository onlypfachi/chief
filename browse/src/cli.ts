/**
 * chief CLI — thin wrapper that talks to the persistent server
 *
 * Flow:
 *   1. Read .chief/browse.json for port + token
...
async function main() {
  ...
  if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
    console.log(`chief browse — Fast headless browser for AI coding agents
